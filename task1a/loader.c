...
/*
 * Function: print_phdr_details
 * ----------------------------
 * Prints detailed information about a program header, similar to readelf -l output.
 *
 * Parameters:
 *   phdr - Pointer to the current program header.
 *   index - Index of the program header (not used here).
 */
